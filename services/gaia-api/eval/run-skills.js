...
const CASES = [
  ...
  { id: 'sk-05', cat: 'generic analysis', input: 'Analyseer deze architectuur op basis van de vorige bevindingen.', intent: { intent: 'inform.explain', status: 'accepted', sourceOfTruth: 'external_knowledge' }, registry: [{ id: 'hermes' }, { id: 'native' }, { id: 'conversation_search' }, { id: 'hindsight' }], expected: { plan: false, action: 'native', skill: null } },
